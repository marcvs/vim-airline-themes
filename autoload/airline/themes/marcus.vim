...
let g:airline#themes#marcus#palette = {}
...
" declared.
let g:airline#themes#marcus#palette.normal_modified = {
...
let g:airline#themes#marcus#palette.insert_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 255     , 53      , ''     ] ,
      \ }
let g:airline#themes#marcus#palette.insert_paste = {
      \ 'airline_a': [ s:airline_a_insert[0]   , '#d78700' , s:airline_a_insert[2] , 172     , ''     ] ,
      \ }

let g:airline#themes#marcus#palette.terminal = airline#themes#generate_color_map(s:airline_a_insert, s:airline_b_insert, s:airline_c_insert)

let g:airline#themes#marcus#palette.replace = copy(g:airline#themes#marcus#palette.insert)
let g:airline#themes#marcus#palette.replace.airline_a = [ s:airline_b_insert[0]   , '#af0000' , s:airline_b_insert[2] , 124     , ''     ]
let g:airline#themes#marcus#palette.replace_modified = g:airline#themes#marcus#palette.insert_modified
...
let g:airline#themes#marcus#palette.visual = airline#themes#generate_color_map(s:airline_a_visual, s:airline_b_visual, s:airline_c_visual)
let g:airline#themes#marcus#palette.visual_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 255     , 53      , ''     ] ,
      \ }
...
let g:airline#themes#marcus#palette.commandline = airline#themes#generate_color_map(s:airline_a_commandline, s:airline_b_commandline, s:airline_c_commandline)
...
let g:airline#themes#marcus#palette.accents = {
      \ 'red': [ '#ff0000' , '' , 160 , ''  ]
      \ }
...
if get(g:, 'loaded_ctrlp', 0)
  let g:airline#themes#marcus#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
